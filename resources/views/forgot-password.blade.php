...
<head>
    ...
    <title>SocialNet | Відновлення паролю</title>
...
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="card p-4 w-100" style="max-width: 400px;">
        <div class="text-center mb-4">
            <h2 class="fw-bold text-primary">Відновлення паролю</h2>
            <p class="text-muted">Введіть свій email, щоб отримати посилання для скидання пароля</p>
        </div>
        ...
        <form action="{{ route('password.email') }}" method="POST">
            ...
            <div class="d-grid mb-3">
                <button type="submit" class="btn btn-primary btn-lg">Відправити посилання</button>
            </div>
